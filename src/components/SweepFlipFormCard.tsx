...
import SweepFlipForm from './SweepForm'
...
const SweepFlipFormCard = ({ chainId, activeTab }: FormCardProps) => {
  ...
  const [sweepAndFlip, setSweepAndFlip] = useState<boolean>(false)
  ...
  useEffect(() => {
    setSweepAndFlip(activeTab === 'sweepFlip')
...
export default SweepFlipFormCard
